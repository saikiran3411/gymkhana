...
.fa-skype {
  ...
  color: white;
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="s-promo-block-v3 g-bg-position--center g-fullheight--md js__parallax-window" style="background: url(img/1920x1080/dramatics.jpg) 100%  no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-ver-center--md g-padding-y-150--xs g-padding-y-0--md">
                <div class="g-margin-b-60--xs">

                  
                    <h1 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white g-letter-spacing--1">THE FOURTH WALL </h1>
                    <p class="g-font-size-18--xs g-font-size-26--md g-color--white-opacity g-margin-b-0--xs">THE DRAMATICS SOCIETY.</p>
                </div>
            ...
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-60--xs g-margin-b-100--md">
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="img/400x500/dramatics.jpg" alt="Image">
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col g-margin-b-60--xs g-margin-b-0--md">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".2s">
                        <img class="img-responsive" src="img/400x550/dramatics.jpg" alt="Image">
                    </div>
                </div>
                <div class="col-sm-1"></div>
                <div class="col-sm-5 g-hor-centered-row__col">

                    <h2 class="g-font-size-32--xs g-font-size-36--sm g-margin-b-25--xs">About Us</h2><?php $dir = "text/about/".$society."_acc.txt";include($dir);?>
                    <!-- Drama lies in extreme exaggeration of the feelings,  an exaggeration that dislocates flat everyday reality. The Fourth Wall - dramatics society of IIT Bhubaneswar encourages young minds to believe in themselves and find their own voice whether its through writing or drama. It is a bunch of Theatre lovers and Nukkad enthusiasts who thrives to bring a change in the society by portraying the problems and issues in an enthralled manner. The society aims at providing a platform to make the audience think out of the box, making connections to life by putting experience in context and connections between the normal and the rational. Providing exposure by performing at various festive occasions, fests and inter-collegiate it gives us an opportunity to learn and improve in all the aspects. --> <p class="g-font-size-18--sm">
    ...
    closedir($dh);}}?>
                  ...
                  <div id="smooth-scroll" class="container g-padding-y-80--xs g-padding-y-125--xsm">
                      <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
                          <div class="col-sm-5 g-hor-centered-row__col">
                              ...
                              <p><a href="mailto:secydrams.sg@iitbbs.ac.in"><img style="height:27px;" src="img/slogo/mail.png"/></a></p>
          ...
          <div class="g-ytsubscribe" data-channelid="UCg3V0Asg8OU44OTVWokG07A" data-layout="default" data-theme="dark" data-count="hidden"></div>
          <br></br>
                          ...
                          <div class="col-sm-5 g-hor-centered-row__col">
                            ...
                            <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FThe-Fourth-WallDramatics-Society-of-IIT-Bhubaneswar-131402333580109%2F&tabs=timeline&width=783&height=600&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500" height="450" style="border:none;overflow:scroll;" scrolling="yes" frameborder="0" allowTransparency="true"></iframe>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 item">
                         ...
                         <div class="col-md-4 item">
                            <div class="team-member">
                                <div class="team-thumb">
                                    <?php echo'<img src="team/14.jpg" alt="Thumb" />';?>
                                    <div class="team-info">
                                        <?php
                                        $dir = "team/details/14.txt";
                                        $dh = fopen($dir, "r");
                                           $details = fread($dh,filesize($dir));
                                           $matter = explode('/', $details);
                                        ?>
