...
.fa-skype {
  ...
  color: white;
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="g-fullheight--md js__parallax-window" style="background: url(img/1920x1080/kalakriti.jpg) 50% 0 no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-ver-center--md g-padding-y-150--xs g-padding-y-0--md">
                <div class="g-margin-b-60--xs">
                    <p><img style="height:250px;" src="img/kalakriti/logo.png"/>   </p>
                    <h1 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white g-letter-spacing--1">KALAKRITI</h1>
                    <p class="g-font-size-18--xs g-font-size-26--md g-color--white-opacity g-margin-b-0--xs">THE FINE ARTS SOCIETY.</p>
                </div>
            ...
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-60--xs g-margin-b-100--md">
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="img/400x500/kalakriti.jpg" alt="Image">
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col g-margin-b-60--xs g-margin-b-0--md">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".2s">
                        <img class="img-responsive" src="img/400x550/kalakriti.jpg" alt="Image">
                    </div>
                </div>
                ...
                <div class="col-sm-5 g-hor-centered-row__col">
                    ...
                    <p class="g-font-size-18--sm"><?php $dir = "text/about/".$society."_acc.txt";include($dir);?>
<!-- Kalakriti Fine Arts Society IIT Bhubaneswar– Established in 2008, the society has been a medium for the students to explore the alleys of creativity in the form of painting, sketching, clay modelling, craft which provides an excellent recreation to the students. The society is a hub for creativity for everyone which brings together like-minded individuals to share their appreciation of and commitment to all sort of arts. We celebrate the festival of lights in different way, making it a special Diwali for the students of IIT Bhubaneswar. Illuminations are created with the help of diyas and illuminated on the night of Diwali.  We are involved in activities like sketching, painting, paper cutting, quilling, origami and other cool stuff. If you are an art lover, enthusiast or just an art critic lingering around in the campus, this is the place for you to be in. We through our distinctive and immersing activities each year promise to make your stay at campus more colorful and full of cbp-l-filters-text -->
					</p>
                </div>
            </div>
        ...
        <div id="smooth-scroll" class="container g-padding-y-80--xs g-padding-y-125--xsm">
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
                <div class="col-sm-5 g-hor-centered-row__col">
                    ...
                    <p><a href="mailto:secyfinearts@sg.iitbbs.ac.in"><img style="height:27px;" src="img/slogo/mail.png"/></a></p>
                ...
                <div class="col-sm-5 g-hor-centered-row__col">
                  ...
                  <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FKalakriti.IITBBS%2F&tabs=timeline&width=783&height=600&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500" height="450" style="border:none;overflow:scroll;" scrolling="yes" frameborder="0" allowTransparency="true"></iframe>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 item">
                            <div class="team-member">
                                <div class="team-thumb">
                                    <?php echo'<img src="team/12.jpg" alt="Thumb" />';?>
                                    <div class="team-info">
                                        <?php
                                        $dir = "team/details/12.txt";
                                        $dh = fopen($dir, "r");
                                           $details = fread($dh,filesize($dir));
                                           $matter = explode('/', $details);
                                        ?>
