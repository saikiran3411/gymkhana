...
.fa-skype {
  ...
  color: white;
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="s-promo-block-v3 g-bg-position--center g-fullheight--md js__parallax-window" style="background: url(img/1920x1080/cinewave.jpg) 100% no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-ver-center--md g-padding-y-150--xs g-padding-y-0--md">
                <div class="g-margin-b-60--xs">
                    <p><img style="height:250px;" src="img/cinewave/logo.png"/>   </p>
                    <h1 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white g-letter-spacing--1">CINEWAVE</h1>
                    <p class="g-font-size-18--xs g-font-size-26--md g-color--white-opacity g-margin-b-0--xs">THE CINEMATICS SOCIETY.</p>
                </div>
            ...
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-60--xs g-margin-b-100--md">
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="img/400x500/cinewave.jpg" alt="Image">
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col g-margin-b-60--xs g-margin-b-0--md">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".2s">
                        <img class="img-responsive" src="img/400x550/cinewave.jpg" alt="Image">
                    </div>
                </div>
                ...
                <div class="col-sm-5 g-hor-centered-row__col">
                    ...
                    <p class="g-font-size-18--sm"><?php $dir = "text/about/".$society."_acc.txt";include($dir);?><!-- Filmmaking, like any other art, is a very profound means of human communication; beyond the professional pleasure of succeeding or the pain of failing, you do want your film to be seen, to communicate itself to other people. Cinewave,the cinematics society of IIT Bhubaneswar provides u an opportunity to make your intellectual thoughts into shortfilms. Apart from this Cinewave won in many short film competitions like Rendezvous-IIT Delhi, Spring Fest-IIT Kharagpur and also in National level competitions like We Care Film making Competition. Cinewave also has an active youtube channel featuring innovative and creative videos -->
                    </p>
                </div>
            </div>
    ...
    closedir($dh);}}?>
              ...
              <div id="smooth-scroll" class="container g-padding-y-80--xs g-padding-y-125--xsm">
                  <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
                      <div class="col-sm-5 g-hor-centered-row__col">
                          ...
                          <p><a href="mailto:secycinesoc.sg@iitbbs.ac.in"><img style="height:27px;" src="img/slogo/mail.png"/></a></p>
      ...
      <div class="g-ytsubscribe" data-channelid="UCYad_h4R7XVMPBbpAbsaOww" data-layout="default" data-theme="dark" data-count="hidden"></div>
      <br></br>
                      ...
                      <div class="col-sm-5 g-hor-centered-row__col">
                        ...
                        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fcinewaveiitbbs%2F&tabs=timeline&width=783&height=600&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500" height="450" style="border:none;overflow:scroll;" scrolling="yes;" frameborder="0" allowTransparency="true"></iframe>
...
<div class="col-md-4 item">
                            <div class="team-member">
                                <div class="team-thumb">
                                    <?php echo'<img src="team/15.jpg" alt="Thumb" />';?>
                                    <div class="team-info">
                                        <?php
                                        $dir = "team/details/15.txt";
                                        if (is_dir($dir)) {
                                            $dh = fopen($dir, "r");
                                           $details = fread($dh,filesize($dir));
                                           $dh = fopen($dir, "r");
