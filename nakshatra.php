...
.fa-skype {
  ...
  color: white;
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="s-promo-block-v3 g-bg-position--center g-fullheight--sm  js__parallax-window" style="background: url(img/1920x1080/6.jpg)100% no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-ver-center--md g-padding-y-150--xs g-padding-y-0--md">
                <div class="g-margin-b-60--xs">

                    <h1 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white g-letter-spacing--1">NAKSHATRHA</h1>
                    <p class="g-font-size-18--xs g-font-size-26--md g-color--white-opacity g-margin-b-0--xs">THE ASTRONOMY SOCIETY.</p>
                </div>
            ...
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-60--xs g-margin-b-100--md">
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="img/400x500/nakshatra.jpg" alt="Image">
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col g-margin-b-60--xs g-margin-b-0--md">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".2s">
                        <img class="img-responsive" src="img/400x550/nakshatra.jpg" alt="Image">
                    </div>
                </div>
                ...
                <div class="col-sm-5 g-hor-centered-row__col">
                    ...
                    <p class="g-font-size-18--sm"><?php $dir = "text/about/".$society."_acc.txt";include($dir);?><!-- A new budding society, ‘Nakshatra’ - the Astronomy Club of IIT Bhubaneswar is formed as a forum to share the events happening in the realm of Astronomy and Cosmology.
Nakshatra is IIT Bhubanesawar’s focal point for amateur astronomers.
Nakshatra boasts of a few telescopes, which are used during the astronomical events by the students to unveil the colors of the Cosmos .

<br>
We organize -  <br>
•	Sky watching sessions at all major astronomical events.
<br>
•	Lecture series on popular topics astronomy and astrophysics.<br>
•	Guest lectures by distinguished speakers.<br>
•	A lot of discussions happens on the Nakshatra WhatsApp Group which is an active platform for Astro-enthusiasts to learn and enjoy Astronomy. -->
</p>
                </div>
            </div>
        ...
        <div id="smooth-scroll" class="container g-padding-y-80--xs g-padding-y-125--xsm">
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
                <div class="col-sm-5 g-hor-centered-row__col">
                    ...
                    <p><a href="mailto:secysnt.sg@iitbbs.ac.in"><img style="height:27px;" src="img/slogo/mail.png"/></a></p>
                ...
                <div class="col-sm-5 g-hor-centered-row__col">
                  ...
                  <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fnakshatraiitbbs%2F&tabs=timeline&width=783&height=600&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500" height="450" style="border:none;overflow:scroll;" scrolling="yes" frameborder="0" allowTransparency="true"></iframe>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-4 item">
                            <div class="team-member">
                                <div class="team-thumb">
                                    <?php echo'<img src="team/9.jpg" alt="Thumb" />';?>
                                    <div class="team-info">
                                        <?php
                                        $dir = "team/details/9.txt";
                                        $dh = fopen($dir, "r");
                                           $details = fread($dh,filesize($dir));
                                           $matter = explode('/', $details);
                                        ?>
