...
.fa-skype {
  ...
  color: white;
        ...
        <!--========== PROMO BLOCK ==========-->
        <div class="g-fullheight--md js__parallax-window" style="background: url(img/1920x1080/clix.jpg) 50% 0 no-repeat fixed;">
            <div class="g-container--md g-text-center--xs g-ver-center--md g-padding-y-150--xs g-padding-y-0--md">
                <div class="g-margin-b-60--xs">
                    <p><img style="height:250px;" src="img/clix/logo.png"/>   </p>
                    <h1 class="g-font-size-40--xs g-font-size-50--sm g-font-size-60--md g-color--white g-letter-spacing--1">CLIX</h1>
                    <p class="g-font-size-18--xs g-font-size-26--md g-color--white-opacity g-margin-b-0--xs">THE PHOTOGRAPHY SOCIETY.</p>
                </div>
            ...
            <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-60--xs g-margin-b-100--md">
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".1s">
                        <img class="img-responsive" src="img/400x500/clix.jpg" alt="Image">
                    </div>
                </div>
                <div class="col-sm-3 col-xs-6 g-hor-centered-row__col g-margin-b-60--xs g-margin-b-0--md">
                    <div class="wow fadeInLeft" data-wow-duration=".3" data-wow-delay=".2s">
                        <img class="img-responsive" src="img/400x550/clix.jpg" alt="Image">
                    </div>
                </div>
                ...
                <div class="col-sm-5 g-hor-centered-row__col">
                    ...
                    <p class="g-font-size-18--sm"><?php $dir = "text/about/".$society."_acc.txt";include($dir);?><!-- Clix, the photography club of Indian Institute of Technology Bhubaneswar continually works together to improve the photographic skills of its working members.Photographic skills range from calibrating the camera properly to taking perfects shots to editing using various software, etc. Clix is not an event coverage society but covers almost all the prominent events of the institute. -->
 </p>
                </div>
            </div>
    ...
    closedir($dh);}}?>
              ...
              <div id="smooth-scroll" class="container g-padding-y-80--xs g-padding-y-125--xsm">
                  <div class="row g-hor-centered-row--md g-row-col--5 g-margin-b-80--xs g-margin-b-100--md">
                      <div class="col-sm-5 g-hor-centered-row__col">
                          ...
                          <p><a href="mailto:clix.photosoc@iitbbs.ac.in"><img style="height:27px;" src="img/slogo/mail.png"/></a></p>
      ...
      <div class="g-ytsubscribe" data-channelid="UCNc_Wvb94Nr6Xd-bS1LNBPg" data-layout="default" data-theme="dark" data-count="hidden"></div>
      <br></br>
                      ...
                      <div class="col-sm-5 g-hor-centered-row__col">
                        ...
                        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fclixiitbbs%2F&tabs=timeline&width=783&height=600&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="500" height="450" style="border:none;overflow:scroll;" scrolling="yes" frameborder="0" allowTransparency="true"></iframe>
  ...
  <div class="col-md-4 item">
   ...
   <div class="col-md-4 item">
                            <div class="team-member">
                                <div class="team-thumb">
                                    <?php echo'<img src="team/10.jpg" alt="Thumb" />';?>
                                    <div class="team-info">
                                        <?php
                                        $dir = "team/details/10.txt";
                                        $dh = fopen($dir, "r");
                                           $details = fread($dh,filesize($dir));
                                           $matter = explode('/', $details);
                                        ?>
